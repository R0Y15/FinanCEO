...
const UserStatsCard = ({ name, value, percentage, color }: UserStatsCardProps) => {
    return (
        <>
            <div className={`flex border h-20 w-60 rounded-xl border-l-8 hover:bg-gray-50 cursor-pointer dark:border-gray-700 dark:bg-gray-900 text-black dark:text-white 
  ...
  ${color === 'yellow' ? 'border-l-yellow-500 dark:border-l-yellow-500' : ''}`}>
                {/* <div className={`flex border h-20 w-60 rounded-xl border-l-8 border-l-yellow-500 hover:bg-gray-50`}> */}
